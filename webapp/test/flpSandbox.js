		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Academia2022zluuc3tenis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Academia2022zluuc3tenis-display": {
								"semanticObject": "Academia2022zluuc3tenis",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Academia2022.zluuc3tenis",
									"url": sap.ui.require.toUrl("Academia2022/zluuc3tenis")
								}
							}
						}
					}
